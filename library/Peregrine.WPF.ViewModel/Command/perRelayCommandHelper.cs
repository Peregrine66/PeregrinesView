...
namespace Peregrine.WPF.ViewModel.Command
{
    public static class perRelayCommandHelper
    {
        ...
        public static perRelayCommandBase ObservesInternalProperty(this perRelayCommandBase command, INotifyPropertyChanged source, string propertyName)
        {
        ...
        public static perRelayCommandBase ObservesExternalProperty(this perRelayCommandBase command, INotifyPropertyChanged source, string propertyName)
        {
        ...
        public static perRelayCommandBase ObservesCollection(this perRelayCommandBase command, INotifyCollectionChanged collection)
        {
